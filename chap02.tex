...
No artigo que originou o método~\cite{kane1965derivation}, Kane e Wang resumem
...
melhorias no Sophia para eficiência algébrica e também o pacote \texttt{exmex},
para exportação das equações de movimento para solução numérica no MATLAB ou
Octave.
...
coeficientes de Rayleigh aos resultados experimentais de análise modal.
