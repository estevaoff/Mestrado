...
\begin{figure}[h]
	\centering 
 	...
 	\caption[Robôs de inspeção]{Robôs de inspeção: a) tanques subterrâneos; b)
 	pontes. \\ Fonte: adaptado de \cite{mavroidis1995end}}
...
energética~\cite{escaler2006detection}. A Figura~\ref{fig::rijeza_hvof}
apresenta o revestimento sendo aplicado antes da instalação por um braço
robótico, em ambiente bem estruturado.
...
Para atenuar este problema, foi projetado um sistema robótico, denominado EMMA,
para reaplicação do revestimento dentro da unidade geradora, que dispensa a
necessidade de desmontagem das pás, realizando todo o processo de revestimento
\textit{in situ}. Este sistema tem o desafio de lidar com o difícil e limitado
acesso, operar em ambiente confinado, de superfície curva, inclinada e
escorregadia, alta umidade e temperatura. Pelo acesso ser limitado a uma
escotilha de $800~mm$ e outra de $350~mm$ de diâmetro, o sistema deve ser
modular e leve, a fim de ser transportado e montado manualmente no interior da turbina. A
Figura~\ref{fig::turbina_ug} ilustra o interior da unidade geradora, destacando
os principais equipamentos no interior e indicando os acessos da escotilha
superior e escotilha inferior.
...
Precisão do manipulador        & 5 mm          		\\
Distância da pistola para a pá & 230-240 mm 		\\
Ângulo da pistola para a pá    & 90$^{\circ}$         \\
Velocidade do efetuador        & 40 m min$^{-1}$   		\\
Ruído sonoro do HVOF           & 100-140 dB    		\\
Temperatura da pá              & até 110$^{\circ}$    \\ \bottomrule
\end{tabular}
\end{table}
