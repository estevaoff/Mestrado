...
\begin{figure}[h]
	\centering 
 	...
 	\caption[Estrutura experimental do Shaky II para validação de
 	controle de ponto final]{Estrutura experimental do Shaky II para validação de
...
Diversas operações de inspeção ou manutenção de equipamentos \textit{in situ}
são perigosas ou de difícil acesso para realização humana. Os manipuladores da
classe macro-micro são uma solução interessante para essas operações porque
fornecem um espaço de trabalho ampliado pelo manipulador macro, assim como toda
a precisão e agilidade de um manipulador micro.
...
\begin{figure}[h]
	\centering 
 	...
 	pontes. \\ Fonte:
 	adaptado de \cite{mavroidis1995end}}
 	\label{fig::inspection_robots}
\end{figure}

Um exemplo é o sistema de remoção e transporte de resíduos nucleares (WD\&C) de
tanques subterrâneos, cujo acesso é limitado (Figura~\ref{fig::inspection_robots}.a). Um
manipulador longo e esbelto permite a entrada pelo duto de acesso e o
posicionamento do robô menor para alcançar e remover o material do
tanque~\cite{knape1990development}. Outro exemplo é de sistema robótico de longo alcance para inspeção de pontes
