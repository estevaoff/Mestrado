...
O MBS acoplado considera os 6 graus de liberdade da base (3 tranlações e 3
...
acordo com a equação~\ref{eq::posf}.\todo{Incluir figura representando a posição e orientação final da
ferramenta}
%
\begin{equation}
