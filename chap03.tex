...
\begin{figure}[h]
	\centering 
 	\includegraphics[width=0.90\textwidth]{figs/erros_exemplo}
...
revolução do desvio. O resultado para o erro em $t=2~s$ é:
%
\begin{equation}
	\omega_{erro}(t=2~s) = [0,6312,~-0,1755,~-0,4278]^Z
\end{equation}
%
...
\begin{figure}[h]
	\centering 
 	\includegraphics[width=0.85\textwidth]{figs/orierro_exemplo}
