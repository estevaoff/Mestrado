...
O MBS acoplado robô e base considera os 6 graus de liberdade da base (3
...
\begin{figure}[h]
	\centering 
 	...
 	\label{fig::carta_badwidth} \todo[inline]{Incluir fonte da carta do martelo}
\end{figure}
...
% -.~.-.~.-.~.-.~.-.~.-.~.-.~.-.~.-.~.-.~.-.~.-
\section{Exemplos de aplicação}\label{sec::casos}
