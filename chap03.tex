...
do ângulo, pode-se comparar este gráfico com o do erro de posicionamento, na
Figura~\ref{fig::erros_exemplo}. É possível inferir que este erro está mais
...
matriz de rigidez é obtida numericamente pela Análise por Elementos Finitos e a
matriz de amortecimento pelo resultado experimental do ensaio de
...
\begin{figure}[h]
	\centering 
 	\includegraphics[width=0.95\textwidth]{figs/estrut_modelo_fisico}
...
bastante detalhada, são incluídos os desenhos das peças a serem fabricadas,
peças comerciais, acessórios de união e fixadores mecânicos que compõe a
montagem CAD da estrutura. Este modelo detalhado é apresentado na
Figura~\ref{fig::estrutCAD}, com os principais componentes indicados, inclusive
o robô.
