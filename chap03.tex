...
%eq1
\begin{multline}
	{\it pWx} = {\it pURx}\,\cos \left( {\it q2}+{\it q3} \right) +{\it pURy
	}\,\sin \left( {\it q2}+{\it q3} \right) \\ -\cos \left( {\it q2}
	 \right) {\it pLUx}-{\it pSLx}-{\it pZSx} \label{eq::pwx}
\end{multline}
%eq2
\begin{multline}
	{\it pWy} = \cos \left( {\it q1} \right) \sin \left( {\it q2}+{\it q3}
 	\right) {\it pURx} \\ -\cos \left( {\it q1} \right) \cos \left( {\it q2}+
	{\it q3} \right) {\it pURy}-\cos \left( {\it q1} \right) \sin \left( {
	\it q2} \right) {\it pLUx}-\cos \left( {\it q1} \right) {\it pSLy}
	\label{eq::pwy}
\end{multline}
%eq3
\begin{multline}
	{\it pWz} = \sin \left( {\it q1} \right) \sin \left( {\it q2}+{\it q3}
 	\right) {\it pURx} \\ -\sin \left( {\it q1} \right) \cos \left( {\it q2}+
	{\it q3} \right) {\it pURy}-\sin \left( {\it q1} \right) \sin \left( {
	\it q2} \right) {\it pLUx}-\sin \left( {\it q1} \right) {\it pSLy}
	\label{eq::pwz}
\end{multline}
%
Os termos como, por exemplo, $pUR_x$ representam as componentes do vetor entre
SC-U e SC-R descritos em U. Esta regra vale para todos os termos semelhantes.
Note-se que os parâmetros do robô são tratados simbolicamente, e desta forma
mantém-se a generalidade do método para a modelagem de qualquer robô
de 6 graus de liberdade com pulso esférico.

Das expressões~\ref{eq::pwx} a \ref{eq::pwz} obtém-se portanto um sistema
não-linear, de 3 equações e 3 incógnitas $q_1, q_2, q_3$. 

Resolver este sistema em uma solução de forma fechada, requer 
